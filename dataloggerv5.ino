...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    if (dataFile) {
      ...
      sendDataToGoogleSheets(ambientTemperature, humidity, motorTemperature, accidentDetected ? "Accident Detected" : "No Accident", switchState == HIGH ? "NO COLLISION" : "Collision ALERT", speedKMH);
    } else {
